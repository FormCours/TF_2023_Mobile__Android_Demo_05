...
import be.tftic.web2023.demo05_list.databinding.ActivityStudentBinding
import be.tftic.web2023.demo05_list.models.Student
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        */
        ...
        for (student in students) {
            ...
            line.put("firstname", student.FirstName)
